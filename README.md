...
> **Preview.** 0.2.3 is a preview build, signed by Weiyi Shi — see
...
Take [`folio-0.2.3-windows-x64.zip`](https://github.com/lulu-loopp/folio-terminal/releases/download/v0.2.3-preview/folio-0.2.3-windows-x64.zip)
