...
| `powershell-editorsyntax-LICENSE.txt` | <https://github.com/PowerShell/EditorSyntax>, `LICENSE` at commit `742f0b5` | MIT, Microsoft — the PowerShell grammar vendored at `assets/syntaxes/` |
| `powershell-editorsyntax-NOTICES.txt` | <https://github.com/PowerShell/EditorSyntax>, `Third Party Notices.txt` at the same commit | The project that grammar incorporates material from (Guillermo López-Anglada, MIT). **Carries upstream's BOM** |
| `bat-LICENSE-MIT.txt` | <https://github.com/sharkdp/bat>, `LICENSE-MIT` at commit `a02713d` | MIT — the `.sublime-syntax` conversion of that grammar was taken from bat, which is `MIT OR Apache-2.0` |
