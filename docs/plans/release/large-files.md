...
**口径**:`git ls-files -z` 的 1131 个跟踪文件,合计 120,475,925 字节(114.9 MiB),
...
| 4 | 6,719,958 | `crates/bt-app/src/main.rs` | **keep** | 一方源码 |
| 5 | 2,505,592 | `docs/DESIGN.md` | **keep** | 设计正史。公开范围归门 7 裁;门 0 只保证它不带机器路径 |
| 6 | 2,102,164 | `crates/bt-app/src/seats.rs` | **keep** | 一方源码 |
...
| 12 | 1,313,494 | `crates/bt-term/src/session.rs` | **keep** | 一方源码 |
...
| 28 | 538,671 | `crates/bt-platform/src/lib.rs` | **keep** | 一方源码 |
