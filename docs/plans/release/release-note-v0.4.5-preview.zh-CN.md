...
| 文件 | 说明 |
| --- | --- |
| `folio-0.4.5-windows-x64.zip` | 十个归属文件，打包在一个文件夹中 — `sha256:91c1a8bf5e0c09500c44aea2a78fe51258377486084b62027896ef45ceed2c98` |
...
| 文件 | 说明 |
| --- | --- |
| `Folio-0.4.5-macos-arm64.dmg` | 应用程序，已签名并经过 Apple 公证 — `sha256:7052892ef8343085e4c7be8b46392089abc55956ade37458c9ad686e2ef79b53` |
