...
| asset | what it is |
| --- | --- |
| `folio-0.4.5-windows-x64.zip` | the ten files that belong together, in one folder — `sha256:<!-- checksums -->` |
...
| asset | what it is |
| --- | --- |
| `Folio-0.4.5-macos-arm64.dmg` | the application, signed and notarized — `sha256:<!-- checksums -->` |
