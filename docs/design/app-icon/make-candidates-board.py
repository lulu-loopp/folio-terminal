...
def main() -> None:
    ...
    pen.text(
        (MARGIN, y),
        "Today's placeholder — assets/app-icon/folio.ico, the sheet folded once that "
    ...
    pen.text(
        ...
        "Rendered by docs/design/app-icon/make-candidates-board.py — headless Chromium per size, "
        "nearest-neighbour magnification only. Sources: docs/design/app-icon/candidates/{a..e}.svg",
        font=TINY,
        fill=QUIET,
    )
