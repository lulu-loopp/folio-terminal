...
**Totals: 31 deviations, touching 52 constants.** A 0 · B 9 · C 11 · D 11.
...
| 27 | T6 | 10.5-pt badges, pills and hashes | `settings.rs::PROFILE_BADGE_FONT_LOGICAL_PX`, `peek_strip.rs::LEAF_FONT_LOGICAL_PX` | 10.5 | 10 | Badge (`theme.rs::WINDOW_TAB_BADGE_FONT_LOGICAL_PX` and 5 more). |
...
| 29 | S8 | Row text inset: restore list, settings nav | `restore.rs::ROW_PADDING_X_LOGICAL_PX`, `settings.rs::NAV_ITEM_PADDING_LEFT_LOGICAL_PX` | 8, 12 | 10 | `profiles.rs::ITEM_PADDING_X_LOGICAL_PX`, `settings.rs::ITEM_PADDING_X_LOGICAL_PX`, `palette.rs::ROW_PADDING_X_LOGICAL_PX`, `theme.rs::RAIL_TAB_PADDING_LEFT_LOGICAL_PX`. |
