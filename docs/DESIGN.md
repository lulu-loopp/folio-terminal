...
### 7.29 一页渲染出来的字是可以被拿走的:选区落在排版层,复制的是「读到的字」(md 预览选区块,2026-08-28 用户实证,已落地;`crates/bt-app/src/preview_select.rs`(新)、`crates/bt-app/src/{main,profiles,table_block}.rs`、`crates/bt-render/src/lib.rs`)
