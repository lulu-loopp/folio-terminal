...
./scripts/release/smoke.ps1 -Exe target/release/folio.exe -ExpectSigned `
    -Msix target/release-package/folio-0.2.5-windows-x64.zip
```
...
$arguments = @('release', 'create', 'v0.2.5-preview') + $assets + @(
    '--draft', '--prerelease',
    '--title', 'Folio 0.2.5',
    '--notes-file', 'docs/plans/release/release-note-v0.2.5-preview.md')
& gh @arguments
```
