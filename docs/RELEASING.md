...
./scripts/release/smoke.ps1 -Exe target/release/folio.exe -ExpectSigned `
    -Msix target/release-package/folio-0.3.0-windows-x64.zip
```
...
$arguments = @('release', 'create', 'v0.3.0-preview') + $assets + @(
    '--draft', '--prerelease',
    '--title', 'Folio 0.3.0',
    '--notes-file', 'docs/plans/release/release-note-v0.3.0-preview.md')
& gh @arguments
```
