...
/// v17 -> v18: how tall a focus card's body stands, defaulted to **the height it already was**.
///
/// One key an eighth time, and it lands the way v13–v16 did rather than the way v17 did: this
...
///
/// See `SettingsV1::focus_card_height`, and that field's note on why the version number this step
/// stamps may still move by one before it merges.
