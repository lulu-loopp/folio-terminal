...
pub use motion::{
    ...
    MOTION_TRAVEL_LOGICAL_PX, MotionKind, MotionSpan, POPUP_ENTER, POPUP_ENTER_MS, POPUP_EXIT,
    POPUP_EXIT_MS, RAIL_TEXT_FADE_MS, RAIL_TEXT_FADE_OPEN_DELAY_MS, RAIL_TRANSITION_MS, Travel,
