...
pub use motion::{
    EASE, EASE_IN_OUT, FLOAT_WINDOW_ANIMATION_MS, GRAB_EASE, MOTION_ARCHIVE_MS, MOTION_BASE,
    MOTION_BASE_MS, MOTION_FAST, MOTION_FAST_MS, MOTION_SLOW, MOTION_SLOW_MS,
    MOTION_TRAVEL_LOGICAL_PX, MotionKind, MotionSpan, RAIL_TEXT_FADE_MS,
    RAIL_TEXT_FADE_OPEN_DELAY_MS, RAIL_TRANSITION_MS, WINDOW_TAB_BREATHE_PERIOD_MS,
