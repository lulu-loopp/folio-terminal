...
/// ANSI colors 0-15 for the light theme, using the user-selected Notion Ink palette.
...
mod tests {
    ...
    #[test]
    fn ansi_palettes_pin_campbell_dark_and_notion_ink_light_byte_for_byte() {
        ...
        assert_eq!(ansi_16_rgb_for(Theme::Light), &NOTION_INK);
    }
