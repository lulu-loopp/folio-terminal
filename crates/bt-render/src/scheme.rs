...
impl ChromePalette {
    ...
    pub fn derive(scheme: &ColourScheme) -> Self {
        ...
        Self {
            ...
            formula_tool_glyph: ink3(termbg),
            formula_tool_pill: row_hover,
            formula_tool_pill_pressed: row_selected,
            formula_tool_glyph_on_pill: ink(row_hover),
            termhost: panel,
...
mod tests {
    ...
    fn assert_palettes_match(name: &str, got: ChromePalette, want: ChromePalette) {
        ...
        same!(
            ...
            formula_tool_glyph,
            formula_tool_pill,
            formula_tool_pill_pressed,
            formula_tool_glyph_on_pill,
            termhost,
            pane_head_edge,
            pane_title,
            pane_title_focus,
