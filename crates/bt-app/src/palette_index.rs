...
/// How deep under the root the index reaches (`docs/DESIGN.md` §7.55 ④).
///
...
/// How many files one root's index may hold (`docs/DESIGN.md` §7.55 ④).
///
...
/// The per-root register (`docs/DESIGN.md` §7.55 ④).
///
