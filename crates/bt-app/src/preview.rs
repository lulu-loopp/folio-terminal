...
pub enum PreviewFtype {
    ...
    Web,
    /// **A video** (user ruling 2026-08-27; `docs/DESIGN.md` §7.21) — a name in
    /// [`VIDEO_EXTENSIONS`].
    ///
...
pub enum PreviewView {
    ...
    /// browser.
    Web,
    /// **One video, standing still** (user ruling 2026-08-27; §7.21).
    ///
    ...
    /// `docs/DESIGN.md` §7.21 ④), and it will arrive as a different view rather
...
mod tests {
    ...
    fn no_video_spelling_is_a_page_until_something_hosts_it_inside_one() {
        ...
        // **Where they land instead** (user ruling 2026-08-27; §7.21). Until
    ...
    /// every entry** (user ruling 2026-08-27; §7.21).
    ///
