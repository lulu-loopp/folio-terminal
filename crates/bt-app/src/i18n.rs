...
impl Text {
    ...
    pub fn in_lang(self, lang: Lang) -> &'static str {
        match self {
            ...
            // zh: pending — listed in `CHINESE_PENDING`.
            Self::PreviewAnimationFileTooLong => pick(
                lang,
                "First frame · file too long",
                "First frame · file too long",
            ),
            ...
            Self::FolderMenuNewFile => pick(lang, "New file…", "新建文件…"),
            Self::FolderMenuNewFolder => pick(lang, "New folder…", "新建文件夹…"),
            Self::FileMenuDelete => pick(lang, "Delete", "删除"),
