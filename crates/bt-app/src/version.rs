...
/// **The tag this build was released under** — `v0.4.3-preview`.
///
...
mod tests {
    ...
    /// diagnostic file. Red gate: write `0.4.3` into any one of the four by hand
    ...
    ///
    /// Red gate: write `0.4.3` into either field of the template by hand. The
